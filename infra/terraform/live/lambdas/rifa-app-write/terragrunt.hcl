...
inputs = {
  ...
  lambda_runtime      = get_env("LAMBDA_RUNTIME", "python3.11")
  lambda_memory_size  = tonumber(get_env("LAMBDA_MEMORY_SIZE", "256"))
  lambda_timeout      = tonumber(get_env("LAMBDA_TIMEOUT", "10"))
  ...
  environment = {
    ...
    AUTO_MIGRATE          = get_env("AUTO_MIGRATE", "true")
