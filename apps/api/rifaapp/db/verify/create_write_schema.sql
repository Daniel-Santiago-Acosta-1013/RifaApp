SELECT 1 FROM write.raffles LIMIT 1;
SELECT 1 FROM write.participants LIMIT 1;
SELECT 1 FROM write.users LIMIT 1;
SELECT 1 FROM write.tickets LIMIT 1;
SELECT 1 FROM write.purchases LIMIT 1;
